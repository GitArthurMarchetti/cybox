                    ...
                    <div className="w-[45%] m-auto   bg-[#0F0F0F] flex flex-col pb-8   rounded-[25px] text-white" >
                         ...
                         <div className="w-4/5 m-auto flex flex-col ">
                              <label className="bg-[#2C2C2C] text-lg flex flex-col  gap-1 p-2 px-4 my-4 rounded-lg text-[#B4B4B4]" >
                                   Nome:
                                   <input className="w-11/12 px-2 bg-transparent border-0 outline-none text-white" type="text" />
                              </label>
                              <label className="bg-[#2C2C2C] text-lg flex flex-col  gap-1 p-2 px-4 my-4 rounded-lg text-[#B4B4B4]" >
                                   Email:
                              ...
                              <div className="flex gap-2">
                                   <label className="bg-[#2C2C2C] text-lg flex flex-row items-center  p-2 px-4 my-4 rounded-lg text-[#B4B4B4]" >
                                        <div className="flex w-full flex-col gap-1">
                                             Senha:
                                             <input className="w-11/12 px-2 bg-transparent border-0 outline-none text-white" type={isVisible ? "text" : "password"} />
                                        </div>
                                   ...
                                   <label className="bg-[#2C2C2C] text-lg flex flex-row items-center  p-2 px-4 my-4 rounded-lg text-[#B4B4B4]" >
                                        <div className="flex w-full flex-col gap-1">
                                             Confirmar senha:
                                             <input className="w-11/12 px-2 bg-transparent border-0 outline-none text-white" type={isVisible2 ? "text" : "password"} />
                                        </div>
